...
bool GroupDirsByBrand::is_done(fs::path entity) const {
    ...
    for (auto const& file : files) {
        ...
        try {
            ...
            if (fs::exists(new_file)) {
                throw std::runtime_error("This Eurocode folder already exists in the Brand folder");
            }
