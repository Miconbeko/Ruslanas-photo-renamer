...
class Utils {
    ...
    public:
        ...
        static void handle_error(std::string err, std::string err_type = "ERROR", dye::R<std::string> (*func)(std::string) = dye::on_red);
        static void handle_error(std::exception& err, std::string err_type = "ERROR", dye::R<std::string> (*func)(std::string) = dye::on_red);
        static void handle_info(std::string info, fs::path initial_dir, fs::path old_entity, fs::path new_entity, dye::R<std::string> (*func)(std::string));
